...
import com.kshem.homesecurity.exceptions.LocalPropertyNotFound;
import com.kshem.homesecurity.exceptions.WrongValueTypeException;
import com.kshem.homesecurity.models.LocalProperty;
import com.kshem.homesecurity.models.LocalProperty_;
...
public class LocalPropertyHelper {
    ...
    public static final String ALARM_ARMED_STATE = "alarm_armed_state";
    ...
    public static void setPowerState(boolean powerState){
        putProperty(POWER_STATE, powerState);
    }

    public static boolean getPowerState(){
        return getBooleanValue(POWER_STATE, false);
    }

    public static void setAlarmArmedState(boolean armed){
        putProperty(ALARM_ARMED_STATE, armed);
    }

    public static boolean getAlarmArmedState(){
        return getBooleanValue(ALARM_ARMED_STATE, true);
    }

    public static void setAlarmTimeout(int timeout){
        putProperty(ALARM_TIMEOUT, timeout);
    }

    public static int getAlarmTimeout(){
        return getIntValue(ALARM_TIMEOUT, 5);
    }
    ...
    public static String getMqttClientId(){
        return getStringValue(MQTT_CLIENT_ID, "control_app");
    }
